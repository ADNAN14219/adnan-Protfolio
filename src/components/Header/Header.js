...
const Header = () => {
    ...
    const resumeUrl = 'https://drive.google.com/drive/u/3/folders/1-1bxJB2N1SwcKuoPcnPDtwzp9Av4rMe_'
        ...
        <div>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-4">
                <div class="container text-uppercase">
                    <Link to="/home" className="navbar-brand fw-bold cool-link">ADNAN AL SHAHRIYAR</Link>
